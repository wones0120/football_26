...
TARGET_TABLES: list[TargetTable] = [
    ...
    TargetTable("model_challenger_evaluation", "predictions", 3, True, "Champion/challenger gates"),
    TargetTable("model_promotion_decision", "predictions", 3, True, "Approved promotion and rollback"),
