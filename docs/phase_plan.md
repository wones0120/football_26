...
3. Phase 3 historical feature, projection, uncertainty, calibration, walk-forward learning, and default-off online residual scoring are implemented and evidence-backed.
...
### Next
1. Add a future-safe game-regime ensemble with global fallback.
2. Add durable checkpoint/resume for 100k-500k candidate runs.
3. Add nightly benchmark scheduling, retention, and CI database/migration smoke coverage.
